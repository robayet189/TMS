...
urlpatterns = [
    ...
    path('api/login/', views.login_user, name='login_user'),  # ✅ Handles role-based redirect
    ...
    # ================= USER DASHBOARD =================
    path('dashboard/', views.dashboard, name='dashboard'),  # ✅ Student dashboard with role check
    ...
    path('driver/dashboard/', views.driver_dashboard, name='driver_dashboard'),  # ✅ Driver dashboard with security
