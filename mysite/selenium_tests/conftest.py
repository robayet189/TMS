...
# ✅ STEP 2: Initialize Django app registry (for imports only, NOT for DB access)
import django
django.setup()

# ✅ STEP 3: Now import Django models (for reference only, NOT for DB access in fixtures)
